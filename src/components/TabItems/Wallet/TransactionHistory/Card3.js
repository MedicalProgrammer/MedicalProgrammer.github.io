                    ...
                    <div className='w-full h-fit  bg-purple-700 p-0 rounded-lg'>
                        ...
                        <div class="bg-gray-50  dark:bg-gray-800 p-3 rounded-lg">
                                    ...
                                    <dl class="bg-orange-50 dark:bg-gray-700 rounded-lg flex flex-col items-center justify-center h-[78px]">
                                        <dt class="w-8 h-8 rounded-full bg-orange-100 dark:bg-gray-600 text-orange-600 dark:text-orange-300 text-sm font-medium flex items-center justify-center mb-1">
                                            {props.total_count}
                                        </dt>
                                        <dd class="text-orange-600 dark:text-orange-300 text-sm font-medium">Total Count</dd>
                                    </dl>
                                    </div>
