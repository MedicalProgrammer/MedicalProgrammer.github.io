            ...
            <>
                    ...
                    <div className='w-full h-fit bg-purple-700 p-0 rounded-lg'>
                        ...
                        <div class="bg-white dark:bg-gray-900 p-3 rounded-lg">
                                    ...
                                    <dl class="bg-orange-50 px-5 dark:bg-gray-800 rounded-lg flex flex-col items-center justify-center h-[78px]">
                                        <dt class="w-full h-8 rounded-full bg-orange-100 dark:bg-gray-700 text-orange-600 dark:text-orange-200 text-sm font-medium flex items-center justify-center mb-1">
                                           $ {props.GB_1_1000}
                                        </dt>
                                        <dd class="text-orange-600 dark:text-orange-300 text-sm font-medium">1-1000 gig</dd>
                                    </dl>
                                    <dl class="bg-teal-50 px-5 dark:bg-gray-800 rounded-lg flex flex-col items-center justify-center h-[78px]">
                                        <dt class="w-full h-8 rounded-full bg-teal-100 dark:bg-gray-700 text-teal-600 dark:text-teal-200 text-sm font-medium flex items-center justify-center mb-1 ">
                                           $ {props.GB_1000_5000}
                                        </dt>
                                        <dd class="text-teal-600 dark:text-teal-300 text-sm font-medium">1000-5000 gig</dd>
                                    </dl>
                                   
                                    <dl class="bg-blue-50 px-5 dark:bg-gray-800 rounded-lg flex flex-col items-center justify-center h-[78px]">
                                        <dt class="w-full h-8 rounded-full bg-blue-100 dark:bg-gray-700 text-blue-600 dark:text-blue-200 text-sm font-medium flex items-center justify-center mb-1">
                                           $ {props.GB_5000_more}
                                        </dt>
                                        <dd class="text-blue-600 dark:text-blue-300 text-sm font-medium">More 5000 gig</dd>
                                    </dl>
                                    </div>
