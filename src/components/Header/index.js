...
<div className="pb-20">
    <Navbar fluid={true} rounded={false} className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0  border-b border-gray-200 dark:border-gray-600 ">
      <Navbar.Brand className="container flex flex-wrap items-center justify-between  mx-auto pb-1">
        ...
        <div className="hidden lg:block">
          <Link className="self-center md:text-xl text-lg  whitespace-nowrap dark:text-white  p-5" to="/">
خانه          </Link>
          {login ? (
            <>
              <Link className="self-center md:text-xl text-lg  whitespace-nowrap dark:text-white  p-5" to="/profile">
                Profile
              </Link>
            ...
            <Link className="self-center md:text-xl text-lg  whitespace-nowrap dark:text-white  p-5" to="/services">
              خدمات کلینیک
            </Link>
          )}
        </div>
