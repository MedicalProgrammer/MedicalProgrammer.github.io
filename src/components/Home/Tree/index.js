...
قبل و بعد از عمل  زیبایی            </h2>
            <h2 class=" mb-4 text-1xl tracking-tight font-bold text-gray-900 dark:text-white">
            <p>آیا می خواهید <strong>به طور طبیعی پیر شوید</strong>؟ ما در این مورد به شما کمک خواهیم کرد. با <strong>درمان های زیبایی کم تهاجمی</strong> ما، این فرصت را دارید که <strong>چروک ها را کاهش دهید</strong> و با ظاهری تازه احساس خوبی داشته باشید.</p>     
            </h2>
          ...
          >
نمونه های بیشتر          </button>
        </Link>
          </div>
          <div className=" w-full rounded-xl">
        <div className="rounded-xl">
          <ReactCompareImage  handleSize={50} handle={<FaArrowsAltH/>}  sliderLineColor="#700E7F" leftImage={before} rightImage={after} />
