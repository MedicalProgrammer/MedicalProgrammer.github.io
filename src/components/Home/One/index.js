      ...
      <section class=" bg-white dark:bg-gray-900">
        <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          ...
          <div class="mt-4 md:mt-0">
            ...
            <li>تزریق فیلر(خط خنده، حجیم سازی لب، فیلر بینی)
</li>
            <li>تزریق بوتاکس با بهترین مواد</li>
            <li>لیزر و رفع موهای زاِئد( با دستگاه الکساندارایت کندلا)
</li>
<li>میکرونیدلینگ(جوش، استریا، اسکار، آبرسانی و …)
</li>
<li>کربوکسی تراپی( رفع جوش، جوشگاه، لک و …)
</li>
<li>مزوتراپی(تقویت مو، لیفت و …)
</li>
